  ...
  <div class="wrap">
    ...
    <?php else: ?>
                ...
                <tr id="row-<?= $r['id'] ?>">
                  ...
                  <td>
                    <button class="btn btn-card"
                      onclick="openOfficialIdCardModal('<?= $teamIdEsc ?>', '<?= $nameEsc ?>', '<?= $collegeEsc ?>', '<?= $branchEsc ?>', '<?= $yearEsc ?>', '<?= $rollEsc ?>', '<?= $ieeeEsc ?>', '<?= $ieeeIdEsc ?>')">🪪
          ...
          <div class="card-scroll-wrapper">
            ...
            <div id="printableIdCard"
              ...
              <div
                ...
                <!-- Hidden compatibility hooks for existing JS references -->
                <span id="cardCollege" style="display:none;"></span>
                <span id="cardYear" style="display:none;"></span>
                <span id="cardBranch" style="display:none;"></span>

                <!-- Admission No (for PSCMR) & IEEE Membership No (for IEEE members) -->
                <div id="cardBranchYearGrid"
                  style="display:none; grid-template-columns:1fr; gap:10px; margin-bottom:12px;">
                  <div id="cardRollBox"
                    ...
                    <div id="cardRoll" style="font-size:14px; font-weight:800; color:#064e3b; font-family:'Space Grotesk',monospace;">
                      -
                    </div>
                  </div>
                  <div id="cardIeeeBox"
                    style="display:none; background:#ffffff; border:1px solid #fef08a; border-left:4px solid #f59e0b; border-radius:10px; padding:8px 12px; text-align:left;">
                    <div
                      style="color:#b45309; font-size:10px; font-weight:800; text-transform:uppercase; letter-spacing:0.05em; display:flex; align-items:center; gap:4px; margin-bottom:2px;">
                      <span>⚡</span> IEEE MEMBERSHIP NO
                    </div>
                    <div id="cardIeeeId" style="font-size:14px; font-weight:800; color:#92400e; font-family:'Space Grotesk',monospace;">
                      -
                    </div>
                  </div>
                </div>

                <!-- 3. Events Evaluation Checklist (3 in one row + 3 in other row with checkboxes) -->
                <div style="border:1px solid #cbd5e1; border-radius:12px; overflow:hidden; margin-bottom:12px;">
                  <div
                    style="background:#04091a; color:#ffffff; padding:7px 12px; display:flex; justify-content:space-between; align-items:center; font-size:11px; font-weight:800;">
                    <div style="display:flex; align-items:center; gap:6px;">
                      <span>📋</span> EVENTS EVALUATION CHECKLIST
                    </div>
                    <div style="color:#00f2fe; font-family:'Space Grotesk',sans-serif; font-size:10.5px;">
                      INNOWAVE-2K26
                    </div>
                  </div>

                  <div style="background:#ffffff; padding:10px 8px; display:grid; grid-template-columns:repeat(3, 1fr); gap:8px;">
                    <!-- Row 1: Event 1 -->
                    <div style="display:flex; align-items:center; gap:6px; background:#f8fafc; border:1px solid #cbd5e1; border-radius:6px; padding:6px 6px;">
                      <div style="width:16px; height:16px; min-width:16px; border:1.8px solid #475569; border-radius:3px; background:#ffffff; box-sizing:border-box;"></div>
                      <span style="font-size:10.5px; font-weight:800; color:#0f172a; line-height:1.2;">Technical Quiz</span>
                    </div>

                    <!-- Row 1: Event 2 -->
                    <div style="display:flex; align-items:center; gap:6px; background:#f8fafc; border:1px solid #cbd5e1; border-radius:6px; padding:6px 6px;">
                      <div style="width:16px; height:16px; min-width:16px; border:1.8px solid #475569; border-radius:3px; background:#ffffff; box-sizing:border-box;"></div>
                      <span style="font-size:10.5px; font-weight:800; color:#0f172a; line-height:1.2;">Coding Challenge</span>
                    </div>

                    <!-- Row 1: Event 3 -->
                    <div style="display:flex; align-items:center; gap:6px; background:#f8fafc; border:1px solid #cbd5e1; border-radius:6px; padding:6px 6px;">
                      <div style="width:16px; height:16px; min-width:16px; border:1.8px solid #475569; border-radius:3px; background:#ffffff; box-sizing:border-box;"></div>
                      <span style="font-size:10.5px; font-weight:800; color:#0f172a; line-height:1.2;">Tech Treasure Hunt</span>
                    </div>

                    <!-- Row 2: Event 4 -->
                    <div style="display:flex; align-items:center; gap:6px; background:#f8fafc; border:1px solid #cbd5e1; border-radius:6px; padding:6px 6px;">
                      <div style="width:16px; height:16px; min-width:16px; border:1.8px solid #475569; border-radius:3px; background:#ffffff; box-sizing:border-box;"></div>
                      <span style="font-size:10.5px; font-weight:800; color:#0f172a; line-height:1.2;">Project Expo</span>
                    </div>

                    <!-- Row 2: Event 5 -->
                    <div style="display:flex; align-items:center; gap:6px; background:#f8fafc; border:1px solid #cbd5e1; border-radius:6px; padding:6px 6px;">
                      <div style="width:16px; height:16px; min-width:16px; border:1.8px solid #475569; border-radius:3px; background:#ffffff; box-sizing:border-box;"></div>
                      <span style="font-size:10.5px; font-weight:800; color:#0f172a; line-height:1.2;">Prompt Engineering</span>
                    </div>

                    <!-- Row 2: Event 6 -->
                    <div style="display:flex; align-items:center; gap:6px; background:#f8fafc; border:1px solid #cbd5e1; border-radius:6px; padding:6px 6px;">
                      <div style="width:16px; height:16px; min-width:16px; border:1.8px solid #475569; border-radius:3px; background:#ffffff; box-sizing:border-box;"></div>
                      <span style="font-size:10.5px; font-weight:800; color:#0f172a; line-height:1.2;">Reels (1 Min)</span>
                    </div>
                  </div>
                </div>
      ...
      <script>
        ...
        function openOfficialIdCardModal(teamId, name, college, branch, year, roll, ieee, ieeeId) {
          ...
          if (document.getElementById('cardYear')) document.getElementById('cardYear').textContent = year || 'N/A';

          const catEl = document.getElementById('cardCategory');
          const isIeeeMember = (ieee && !String(ieee).toLowerCase().includes('non-ieee') && (String(ieee).toLowerCase() === 'yes' || String(ieee).toLowerCase().includes('ieee')));
          if (catEl) {
            if (isIeeeMember) {
              catEl.textContent = '⚡ IEEE MEMBER';
          ...
          const hasRoll = isPscmr && roll && roll !== 'N/A' && roll !== '-';
          const hasIeee = isIeeeMember && ieeeId && ieeeId !== 'N/A' && ieeeId !== '-';

          const rollBox = document.getElementById('cardRollBox');
          const ieeeBox = document.getElementById('cardIeeeBox');
          ...
          if (ieeeBox) {
            if (hasIeee) {
              document.getElementById('cardIeeeId').textContent = ieeeId;
              ieeeBox.style.display = 'block';
            } else {
              ieeeBox.style.display = 'none';
            }
          }
